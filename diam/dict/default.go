	...
	<application id="16777236" type="auth" name="Rx">
		...
		<avp name="IP-CAN-Type" code="1027" must="M,V" may-encrypt="Y" vendor-id="10415">
			<data type="Enumerated">
				...
				<item code="6" name="Non-TGPP-EPS"/>
				<item code="7" name="FBA"/>
				<item code="8" name="TGPP-5GS"/>
				<item code="9" name="Non-TGPP-5GS"/>
			</data>
		</avp>
...
var tgppslgXML = `<?xml version="1.0" encoding="UTF-8"?>
<diameter>
...
var tgppslhXML = `<?xml version="1.0" encoding="UTF-8"?>
<diameter>
